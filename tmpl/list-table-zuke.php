...
class TDR extends WP_List_Table {
...
function dr(){
    ...
    if(isset($_POST['postdesu'])) {



        if(wp_verify_nonce($_POST['test'],"test")) {
            $wpdb->query($wpdb->prepare("UPDATE `{$wpdb->postmeta}` SET `meta_value` = %s WHERE `meta_id` = 576;",$_POST['postdesu']));        
        }



    }
        $meta_values = get_post_meta(10, "A1", true);
...
jQuery(function(){
  ...
  */
    ...
    <div class="wrap">
        ...
        <img id="image-view" src="" alt="">
        <form method="post" action="options.php">
            <input type="text" neme="myplg_options">
            <select name="postdesu" id="">
                ...
                ?>
                    ...
                    <option value="<?php echo $value;?>" <?php if($value === $meta_values):?> selected<?php endif;?>><?php echo $value;?></option>
                <?php
